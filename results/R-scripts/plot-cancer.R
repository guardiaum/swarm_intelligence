...
output_static <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/cancer/output_mlp_fips_static_cancer_15.csv",
                          col_names = FALSE)
output_distance <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/cancer/output_mlp_fips_distance_cancer_14.csv",
                           col_names = FALSE)
output_fitness <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/cancer/output_mlp_fips_fitness_cancer_12.csv",
                           col_names = FALSE)
output_classic <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/cancer/output_mlp_pso_cancer_26.csv",
                           col_names = FALSE)
output_cs <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/cancer/output_mlp_cs_cancer_26.csv",
                           col_names = FALSE)
output_ring <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/cancer/output_mlp_ring_cancer_30.csv",
                      col_names = FALSE)
output_pso_w <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/cancer/output_mlp_psow_cancer_22.csv",
                        col_names = FALSE)
output_backpropagation <- 
  read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/cancer/output_backpropagation_cancer_2.csv",
                                                col_names = FALSE)
...
plot(output_backpropagation$iteration[0:600], output_backpropagation$gbest_error[0:600], 
     type='l', lty=1, col = "purple", ylim=c(0, 0.4), 
     xlab='iteration', ylab='error', main='Breast Cancer Dataset')
