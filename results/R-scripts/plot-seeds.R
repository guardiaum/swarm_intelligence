...
output_static <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/seeds/output_mlp_fips_static_seeds_12.csv",
                          col_names = FALSE)
output_distance <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/seeds/output_mlp_fips_distance_seeds_28.csv",
                            col_names = FALSE)
output_fitness <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/seeds/output_mlp_fips_fitness_seeds_6.csv",
                           col_names = FALSE)
output_classic <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/seeds/output_mlp_pso_seeds_28.csv",
                           col_names = FALSE)
output_cs <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/seeds/output_mlp_cs_seeds_5.csv",
                      col_names = FALSE)
output_ring <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/seeds/output_mlp_ring_seeds_30.csv",
                        col_names = FALSE)
output_pso_w <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/seeds/output_mlp_psow_seeds_28.csv",
                         col_names = FALSE)
output_backpropagation <- 
  read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/seeds/output_backpropagation_seeds_2.csv",
           col_names = FALSE)
...
plot(output_backpropagation$iteration[0:600], output_backpropagation$gbest_error[0:600], 
     ...
     xlab='iteration', ylab='error', main='Seeds Dataset')
