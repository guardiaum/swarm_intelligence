...
output_static <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/iris/output_mlp_fips_static_iris_5.csv",
                          col_names = FALSE)
output_distance <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/iris/output_mlp_fips_distance_iris_2.csv",
                            col_names = FALSE)
output_fitness <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/iris/output_mlp_fips_fitness_iris_2.csv",
                           col_names = FALSE)
output_classic <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/iris/output_mlp_pso_iris_23.csv",
                           col_names = FALSE)
output_cs <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/iris/output_mlp_cs_iris_29.csv",
                      col_names = FALSE)
output_ring <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/iris/output_mlp_ring_iris_20.csv",
                        col_names = FALSE)
output_pso_w <- read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/iris/output_mlp_psow_iris_27.csv",
                         col_names = FALSE)
output_backpropagation <- 
  read_csv("~/PycharmProjects/SwarmIntelligence/results/output-files/iris/output_backpropagation_iris_1.csv",
           col_names = FALSE)
...
plot(output_backpropagation$iteration[0:600], output_backpropagation$gbest_error[0:600], 
     type='l', lty=1, col = "purple", ylim=c(0, 0.8), 
     xlab='iteration', ylab='error', main='Iris Dataset')
